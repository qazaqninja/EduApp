...
class CourseInfoProgScreen extends StatefulWidget {
  @override
  _CourseInfoProgScreenState createState() => _CourseInfoProgScreenState();
}

class _CourseInfoProgScreenState extends State<CourseInfoProgScreen>
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Positioned(
              top: (MediaQuery.of(context).size.width / 1.2) - 125.0,
              bottom: 0,
              left: 0,
              right: 0,
              child: Container(
                                ...
                                new ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      return new GestureDetector(
                                        ...
                                        onTap: () {
                                          openPDF(context, id[index].path, id[index].title);
                                        },
